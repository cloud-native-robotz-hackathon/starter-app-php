...
<form action="" method="post">
   ...
   <br><br>
   &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type="submit" name="forward" value="forward(5);"/>
   <br>
   <input type="submit" name="backward" value="backward(5);"/>
   <input type="submit" name="turnleft" value="turnleft(90);"/>
   <br>
   &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type="submit" name="turnright" value="turnright(90);"/>
</form>
